...
files_to_compile = ['Test_Calibration', 'Calibration\calibration']
file_to_compile = 'Test_Calibration'
if len(sys.argv) == 2:
    com_port = 'com6'
else:
	com_port = sys.argv[2]
...
path_win_avr = 'C:/Users/Alecea/Documents/ECE_484_B/avr-gcc-13.2.0-x64-windows/bin/'

if level_of_compilation >= 1: 
    for fs in files_to_compile:
        cmd = path_win_avr + 'avr-gcc.exe -Wall -Os -DF_CPU=16000000UL -mmcu=atmega328p -c --param=min-pagesize=0 -o'+fs+'.o '+fs+'.c'
        run_command(cmd)
